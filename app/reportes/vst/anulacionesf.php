...
$listaAnulaciones = $mventas->getVentasAnuladas($fechai,$fechaf);
$total = $mventas->getTotalAnulado($fechai, $fechaf);
?>
<html>
	<head>
		<meta charset="utf8">
	...
	<body>
		...
		<h1>Anulaciones Realizadas desde el <?php echo $diai."/".$mesi."/".$anioi;?> hasta el <?php echo $diaf."/".$mesf."/".$aniof;?>  </h1>
		<!-- contenido -->
		...
		<table class="table1">
			...
			<tbody>
				<?php if(count($listaAnulaciones)>0) { ?>
					<?php foreach($listaAnulaciones as $la) { ?>
						<tr>
